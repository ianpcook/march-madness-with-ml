...
def get_data(tourney_year):
    ...
    season_detailed_results = format_as_df('./data' + str(year) + '/RegularSeasonDetailedResults.csv')
    tourney_detailed_results = format_as_df('./data' + str(year) + '/TourneyDetailedResults.csv')
